...
Feature: Messages
  ...
  Scenario: Recent messages: When a user loads the messaging page,
    ...
    And the following messages
      ...
      | 1  | Hi Jeff!   | bob  | CUSS | jeff    | AML     | t    | 1441.minutes.ago |
      | 2  | Hello, Bob | jeff | AML  | bob     | CUSS    | t    | 1440.minutes.ago  |
    ...
    Then I should not see recieved message 1 "Hi Jeff!" from desk "CUSS" user "bob"
    And I should not see desk "AML" user "jeff" read message 1
    ...
    And I should see desk "AML" user "jeff" read message 3
